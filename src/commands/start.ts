...
export default class Start extends Command {
    ...
    static examples = [
        `$ twix-bootstrap start -p bootstrap`,
        `$ twix-bootstrap start -p testnet -a dual`,
        `$ twix-bootstrap start -p mainnet -a peer -c custom-preset.yml`,
        `$ twix-bootstrap start -p testnet -a dual --password 1234`,
        `$ twix-bootstrap start -p mainnet -a my-custom-assembly.yml -c custom-preset.yml`,
        `$ twix-bootstrap start -p my-custom-network.yml -a dual -c custom-preset.yml`,
        `$ echo "$MY_ENV_VAR_PASSWORD" | twix-bootstrap start -p testnet -a dual`,
    ];
